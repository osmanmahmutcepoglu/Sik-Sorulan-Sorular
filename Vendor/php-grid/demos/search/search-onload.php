...
// $grid["persistsearch"] = false; // persist search settings on page reload
...
$col["searchoptions"] = array("defaultValue"=>'Maria');
$cols[] = $col;
...
$col["searchoptions"] = array("defaultValue"=>'No',"searchhidden" => true, "sopt" => array("eq"));
$cols[] = $col;
...
<body>
	...
	function reloadGrid()
	{
		...
		var filters = JSON.parse(grid[0].p.postData.filters);
		...
		$.extend(grid[0].p.postData,{filters:JSON.stringify(<?php echo $sarr?>)});
