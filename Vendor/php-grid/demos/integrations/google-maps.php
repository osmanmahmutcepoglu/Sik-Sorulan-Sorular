...
$col["default"] = "<div class='maps' id='map_{id}' style='height:300px' data-address='' data-lat='24.914' data-lng='67.15'></div>";
// $col["default"] = "<div class='maps' id='map_{id}' style='height:300px' data-address='Baloch Colony' data-lat='44.54' data-lng='-78.56'>[Map]</div>";
$cols[] = $col;
