...
$col["name"] = "detail"; 
$col["default"] = "<a class='fancybox' onclick='setTimeout(function(){jQuery(\"#list1\").setSelection({client_id})},200);' href='#box_detail_grid'>View Details</a>"; 
$col["width"] = "40";
$col["editable"] = true;
$col["search"] = false;
$col["export"] = false;
...
<body>
    ...
    #viewmodlist1.ui-jqdialog { z-index: 1020 !important; }
	</style>
	...
	<div id='box_detail_grid' style='width:90%;display:none;'>
	<?php echo $out_detail?>
	</div>
