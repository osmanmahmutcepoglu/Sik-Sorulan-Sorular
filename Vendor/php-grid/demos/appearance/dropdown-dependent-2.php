...
$col["editoptions"] = array(
								...
								"onchange" => array(
												...
												array(	"sql"=>"select note as k, note as v from invheader WHERE client_id = '{client_id}'",
														"update_field" => "note" ),
														
												array(	"sql"=>"select amount as k, amount as v from invheader WHERE client_id = '{client_id}'",
														"update_field" => "amount" )
												)
							);
...
$col["edittype"] = "select"; // display label, not value
